                ...
                <div class="nav-right col-8 pull-right right-header p-0">
                    <ul class="nav-menus">
                        ...
                        <li class="profile-nav onhover-dropdown p-0 me-0">
                            <div class="media profile-media"><img class="b-r-10" src="<?php echo base_url("logos".$rest['rest_Logo']); ?>" alt="">
                                <div class="media-body"><span> <?php echo (htmlspecialchars($rest['rest_Name'])); ?></span>
