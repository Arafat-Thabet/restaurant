...
<div class="pt-2">
   <ul class="breadcrumb">
        ...
        <li class="active"><?=lang('brunch')?> </li>
    </ul>
    </div>
<section  class="card">
 <div class="card-body">
 <div class="text-end">
    ...
    <a class="btn btn-default" href="<?= base_url('branches/from/' . $rest['rest_ID']) ?>" title="Add New Branch">Add New Branch</a>
            <a class="btn btn-danger" href="<?= base_url('branches/photofrom') ?>" title="Add New Branch Photo">Add New Branch Photo</a>  </div>
                            ...
                            <?php foreach ($branches as $p) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="<?=lang("view")?>" class="btn btn-sm btn-primary" target="_blank" href="<?php echo $this->config->item('sa_url') . 'rest/' . $rest['seo_url'] . '/' . $p['br_id']; ?>" rel="tooltip" data-original-title="View ">
                                            <i class="fa fa-eye"></i>
