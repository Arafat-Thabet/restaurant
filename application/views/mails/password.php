    ...
    <td align="center"><table cellpadding="0" cellspacing="0" border="0" width="640" bgcolor="#ffffff">
        <tr>
          <td><table cellpadding="0" cellspacing="0" border="0" width="640">
              ...
              <tr>
                <td align="left" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; padding-left:20px; padding-right:10px; padding-top:12px;" colspan="2"><h1><?php echo ucwords($restname);?> Password Request!</h1></td>
              </tr>
              ...
              <tr>
                <td colspan="2" height="5"><table cellpadding="3" cellspacing="0" border="0" width="600" align="center">
                    <tr>
                     ...
                     Please find your login details bellow.
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="2" height="10px">
                         ...
                         <tr>
                      <td style="padding-top:10px;font-family:Arial, Helvetica, sans-serif; font-size:14px;" width="44%"><strong>Username: </strong></td>
                      <td style="padding-top:10px;font-family:Arial, Helvetica, sans-serif; font-size:14px;" width="56%"><?php echo $username; ?></td>
                    </tr>
                    <tr>
                <td colspan="2" style="border-bottom:1px solid #cccccc;" ></td>
              </tr>
                    <tr>
                      <td style="padding-top:10px;font-family:Arial, Helvetica, sans-serif; font-size:14px;" width="44%"><strong>Password: </strong></td>
                      <td style="padding-top:10px;font-family:Arial, Helvetica, sans-serif; font-size:14px;" width="56%"><?php echo $password;?></td>
                    </tr>
                    <tr>
                <td colspan="2" style="border-bottom:1px solid #cccccc;" ></td>
              </tr>
                ...
                <td colspan="2" ></td>
                    ...
                    <tr>
                      <td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:14px;"> Feel free to contact us for any information at <a href="mailto:info@azooma.co" style="color:#00A2B1;">info@azooma.co</a> or call us on <span style="color:#e60683;font-size:18px;"><?php echo $settings['tel'];?></span>
                      <td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
