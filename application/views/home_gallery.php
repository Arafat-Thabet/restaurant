            ...
            <div class="card">
                ...
                <div class="my-gallery card-body row gallery-with-description" itemscope="">
                    <?php if (isset($gelary_images) and !empty($gelary_images)) { ?>
                       ...
                       // var_dump($g);
                        //exit;
                            if (file_exists(files_path() . 'Gallery/thumb/' . $g->image_full)) {                  ?>
                                <figure class="col-xl-3 col-sm-6" itemprop="associatedMedia" itemscope=""><a href="<?= app_files_url() ?>Gallery/thumb/<?php echo $g->image_full; ?>" itemprop="contentUrl" data-size="1600x950">
                                        <img src="<?= app_files_url() ?>Gallery/thumb/<?php echo $g->image_full; ?>" itemprop="thumbnail" alt="Image description">
                                        <div class="caption">
