...
function switchMapLanguage(map, platform) {
    var mapTileService = platform.getMapTileService({
        ...
        chineseMapLayer = mapTileService.createTileLayer(
            ...
            'png8', { lg: 'CHI', ppi: pixelRatio === 1 ? undefined : 320 }
        );
...
function switchMapType(map, platform) {
    ...
    terrainMap = aerialMapTileService.createTileLayer(
        ...
        'terrain.day',
        pixelRatio === 1 ? 256 : 512,
        'png8', { ppi: pixelRatio === 1 ? undefined : 320 }
    );
...
function addCircleToMap(map) {
    map.addObject(new H.map.Circle({ lat: 28.6071, lng: 77.2127 },
        1000, {
            style: {
